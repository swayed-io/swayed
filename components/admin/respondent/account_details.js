    ...
    return (<div>
            ...
            <div className="flex flex-row">
                <div className="w-1/2 p-4">
                    <div className="grid grid-cols-3">
                        ...
                        <p className="text-base font-medium opacity-80 ">Johnson</p>

                    </div>
                    <div className="grid grid-cols-3 mt-4">
                        <p className="text-sm font-medium opacity-60">Phone</p>
                        <p className="text-base font-medium opacity-80 flex flex-row gap-2 ">+1 123 467 8<img src="/img/icons/account_details/check_icon.svg"/></p>
                ...
                <div className="grid grid-cols-3">
                        ...
                        <p className="text-base font-medium opacity-80 ">Smith</p>
        ...
        <div className="mt-4 rounded-md bg-[#FFD9D9] flex flex-row  p-4">
            <div className=" flex flex-row items-center">
                ...
                <p className="ml-4 text-base font-medium">Please be cautious this operation is not reversible. You will have 30 days to reactivate it<br/> after which it will be deleted.</p>
                </div>
