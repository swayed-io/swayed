          ...
          <div className="flex flex-col sm:p-4 p-2">
            ...
            <div className="flex flex-row space-x-2  ">
              {/* <button className="rounded-full bg-background-100 text-center py-2 px-4 font-medium text-sm   flex flex-row gap-2 ">
                <img
                  src="/img/icons/respondent_d/interview_icon.svg"
                  className="opacity-60"
                />
                <span className="opacity-60">1-on-1 Interview</span>
              </button> */}
              <button className="rounded-full bg-background-100 text-center py-2 px-4 font-medium text-sm   flex flex-row gap-2 ">
                <img
            ...
            <div className="w-full sm:mt-2 mt-4">
              <p className="ml-2 text-sm text-medium text-black sm:leading-relaxed">
                We are looking for individuals who would be willing to try our
                current product that helps sellers launch their online shop in
                less than an hour for free. This will be an online interview
                where you will talk about your experience while using the
                product.
              </p>
            </div>
