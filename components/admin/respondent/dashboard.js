            ...
            <div id="listings" className="sm:p-2 p-4 bg-background-100 w-3/4">
                ...
                <div className="">
                    <div className="flex flex-row justify-between">
                        <p className="font-semibold text-2xl">We need a few more things from you</p>
                        <button className="rounded-full px-4 py-2 border-2 border-secondary-100 text-secondary-100 text-sm font-medium">Skip for now</button>
                    </div>
                    <div className="mt-4">
                        <div className="bg-[#DFEEFD] rounded-md flex flex-row w-full mt-4 p-4">
                            <div className="flex flex-row items-center w-full justify-between">
                                ...
                                <div className="w-3/4 flex flex-row items-center ">
                                    <div className="px-4">
                                        <img src="/img/icons/dashboard/camera_icon.svg" className="mx-auto"/>
                                    </div>
                                    <div className="ml-4">

                                        <p className="text-base text-secondary-100 font-semibold">Upload a profile photo</p>
                                        <p className="text-sm font-medium opacity-80">Required to apply to projects.</p>
                                    </div>
                                </div>

                            </div>
                            <div className="px-4 flex items-center">
                                <img src="/img/icons/dashboard/check_green.svg" className=" items-end"/>
                            </div>
                        ...
                        <div className="bg-[#DFEEFD] rounded-md flex flex-row w-full mt-4 p-4">
                            <div className="flex flex-row items-center w-full justify-between">
                                ...
                                <div className=" flex flex-row items-center ">
                                    <div className="px-4">
                                        <img src="/img/icons/dashboard/message_icon.svg" className="mx-auto"/>
                                    </div>
                                    <div className="ml-4">

                                        <p className="text-base text-secondary-100 font-semibold">Add and verify work email</p>
                                        <p className="text-sm font-medium opacity-80">Required to apply to industry professional projects.</p>
                                    </div>
                                </div>
                            ...
                            <div className=" items-center">
                                <button className="px-2 py-2 bg-white text-xs w-44 mx-auto rounded-full font-medium">I don’t have a work email</button>
                            </div>
                                <img src="/img/icons/dashboard/check_gray.svg" className="ml-2 mr-7 mx-auto"/>
                            </div>
                        ...
                        <div className="bg-[#DFEEFD] rounded-md flex flex-row w-full mt-4 p-4">
                            <div className="flex flex-row items-center w-full justify-between">
                                ...
                                <div className=" flex flex-row items-center ">
                                    <div className="px-4">
                                        <img src="/img/icons/dashboard/linkedin_icon.svg" className="mx-auto"/>
                                    </div>
                                    <div className="ml-4">

                                        <p className="text-base text-secondary-100 font-semibold">Add LinkedIn</p>
                                        <p className="text-sm font-medium opacity-80">Help researchers verify your identity and increase your chances of being selected for projects. </p>
                                    </div>
                                </div>

                            </div>
                            <div className="px-4 flex items-center">
                                <img src="/img/icons/dashboard/check_gray.svg" className=" items-end"/>
                            </div>
                        ...
                        <div className="bg-[#DFEEFD] rounded-md flex flex-row w-full mt-4 p-4">
                            <div className="flex flex-row items-center w-full justify-between">
                                ...
                                <div className="w-3/4 flex flex-row items-center ">
                                    <div className="px-4">
                                        <img src="/img/icons/dashboard/video_icon.svg" className="mx-auto"/>
                                    </div>
                                    <div className="ml-4">

                                        <p className="text-base text-secondary-100 font-semibold flex flex-row items-center">Add personal video introduction <span className="ml-2 px-2 py-1 font-normal bg-gradient-to-r from-primary-100 to-secondary-100 text-white rounded-full border-0   focus:outline-none hover:bg-gray-200  text-xs bg-blue-500 ">NEW</span></p>
                                        <p className="text-sm font-medium opacity-80">This is your chance to personally introduce yourself to researchers.</p>
                                    </div>
                                </div>
                        ...
                        <div className="bg-[#DFEEFD] rounded-md flex flex-row w-full mt-4 p-4">
                            <div className="flex flex-row items-center w-full justify-between">
                                ...
                                <div className="w-3/4 flex flex-row items-center ">
                                    <div className="px-4">
                                        <img src="/img/icons/dashboard/income_icon.svg" className="mx-auto"/>
                                    </div>
                                    <div className="ml-4">

                                        <p className="text-base text-secondary-100 font-semibold">Add your household income</p>
                                        <p className="text-sm font-medium opacity-80">This helps qualify you for more general population projects.</p>
                                    </div>
                                </div>
                ...
                <div className="py-4  flex flex-row gap-x-6">
                    ...
                    <button className="rounded-full bg-white text-center   font-medium text-sm justify-between  w-[48em]  flex flex-row gap-2 ">
                        <span className=" items-center py-3 px-4 text-sm font-medium opacity-40">Search projects by keyword</span><img src="/img/icons/respondent_d/search_icon.svg"/></button>
                    <button className="rounded-full bg-white text-center py-2 px-4 font-medium text-sm     flex flex-row gap-2 items-center "><img src="/img/icons/respondent_d/filter_icon.svg" className="opacity-80"/><span className="opacity-80 text-sm">Filter (0)</span>
                    </button>
                    <button className="rounded-full bg-white text-center py-2 px-4 font-medium text-sm     flex flex-row gap-2  items-center">
                        <span className="opacity-80 text-sm">Sort Most Relevant</span><img src="/img/icons/respondent_d/row_icon.svg" className="opacity-80"/></button>
                ...
                <div className="rounded-xl bg-white">
                    <div className="flex flex-col sm:p-4 p-2">
                        <div className="flex flex-row justify-between">
                            <p className="ml-2 text-[#4965C6] font-bold sm:text-lg text-base">Customer Experience for
                        ...
                        <div className="flex flex-row space-x-2  ">
                            <button className="rounded-full bg-background-100 text-center py-2 px-4 font-medium text-sm   flex flex-row gap-2 "><img src="/img/icons/respondent_d/interview_icon.svg" className="opacity-60"/><span className="opacity-60">1-on-1 Interview</span>
                            </button>
                            <button className="rounded-full bg-background-100 text-center py-2 px-4 font-medium text-sm   flex flex-row gap-2 "><img src="/img/icons/respondent_d/globe_icon.svg" className="opacity-60"/><span className="opacity-60">Online</span>
                            </button>
                            <button className="rounded-full bg-background-100 text-center py-2 px-4 font-medium text-sm   flex flex-row gap-2 "><img src="/img/icons/respondent_d/thunder_icon.svg" className="opacity-60"/><span className="opacity-60">Easy Apply</span>
                            </button>
            ...
            <div className="w-1/4">
                <div>
                    <div className="bg-white rounded-lg  py-4">
                        <p className="text-base font-semibold ml-4">Welcome to Shape the<br/>
                            Future!</p>
                        <p className="text-sm font-medium opacity-60 mt-2 ml-4">We’d love to take you on a quick tour and show you how you can get paid for your opinions and insights.</p>
                ...
                <div className="mt-4">
                    <div className="bg-white rounded-lg  py-4">
                        <p className="text-base font-semibold ml-4">Share your referral link</p>
                        <p className="text-sm font-medium opacity-60 mt-2 ml-4">Earn $20 when you refer a new Respondent user who earns $75 in total incentive.</p>
                        <div className="flex flex-row gap-x-2 ml-4">
                            <button className="px-4 py-2 font-medium bg-gradient-to-r from-primary-100 to-secondary-100 text-white rounded-full border-0   focus:outline-none hover:bg-gray-200  text-xs mt-8 transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110">
                                Share link
                            </button>
