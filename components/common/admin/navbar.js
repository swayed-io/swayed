        ...
        <div className="">
            ...
            <div className="">
                ...
                <div className="flex flex-row  w-64  bg-gradient-to-b from-primary-100  to-secondary-100 ">
                    ...
                    <nav className="from-primary-100 to-secondary-100    flex flex-col mb-16  ">
                        <div className="mt-10 mb-10">
                            ...
                            <div className="mt-10 p-4 ">
                                <ul className="w-56">
                                    <li className="mb-4 active:bg-secondary-100 rounded-xl p-4 hover:bg-secondary-100  active:opacity-100 text-opacity-60 active:text-opacity-100  ">
                                        <Link href="#projects">
                                            <a className="flex flex-row ">
                                                <span>
                                                    <img src="/img/projects_icon.svg" className="w-5 h-5 "/>
                                                </span>
                                                <p className="ml-4 text-white font-medium text-sm ">Projects</p>
                                            </a>
                                        </Link>
                                    </li>
                                    ...
                                    <details className="group [&_summary::-webkit-details-marker]:hidden rounded-lg hover:bg-white hover:bg-opacity-20">
                                        <summary className="flex items-dcenter px-4 py-2  rounded-lg cursor-pointer  ">
                                            <div className="flex flex-row  active:opacity-100 text-opacity-60">
                                        ...
                                        <nav aria-label="Users Nav" className="flex flex-col mt-2 ml-8 space-y-2 py-2 px-2 text-opacity-60 active:opacity-100">
                                            <Link href="#earn">
                                    ...
                                    <li className="mb-4 active:bg-secondary-100 rounded-xl p-4 hover:bg-secondary-100  active:opacity-100 text-opacity-60 active:text-opacity-100  ">
                                        <Link href="#messages">
                                            <a className="flex flex-row ">
                                                <span>
                                                    <img src="/img/messages_icon.svg" className="w-5 h-5 "/>
                                                </span>
                                                <p className="ml-4 text-white font-medium text-sm">Messages</p>
                                            </a>
                                        </Link>
                                    </li>
                                    <li className="mb-4 active:bg-secondary-100 rounded-xl p-4 hover:bg-secondary-100  active:opacity-100 text-opacity-60 active:text-opacity-100  ">
                                        <Link href="#referrals">
                                            <a className="flex flex-row ">
                                                <span>
                                                    <img src="/img/referrals_icon.svg" className="w-5 h-5 "/>
                                                </span>
                                                <p className="ml-4 text-white font-medium text-sm">Referrals</p>
                                            </a>
                                        </Link>
                                    </li>
                                    ...
                                    <li className="mb-4 active:bg-secondary-100 rounded-xl p-4 hover:bg-secondary-100  active:opacity-100 text-opacity-60 active:text-opacity-100  ">
                                        <Link href="#helpcenter">
                                            <a className="flex flex-row ">
                                                ...
                                                <p className="ml-4 text-white font-medium text-sm">Help Center</p>
                                            </a>
                                        </Link>
                                    </li>
                        ...
                        <li className="ml-4 object-bottom  rounded-xl p-4     text-opacity-60   ">
                            <Link href="#">
                                <a className="flex flex-row  ">
                                    <span>
