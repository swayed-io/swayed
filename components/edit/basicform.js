  ...
  return (
    <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8 ">
      <div className="mx-auto max-w-lg">
        ...
        >
          <p className="text-2xl font-medium text-[#413F9D]">Basic Form</p>
          ...
          <div className="">
            ...
            <div className="relative mt-1 flex flex-row">
              <select
                ...
                onChange={(e) =>
                  setFormData({ ...formData, code_country: e.target.value })
                }
              >
              ...
              <input
                ...
                className={`w-full rounded-lg border-gray-200 p-4 pr-12 text-sm shadow-sm ${validation.phone}`}
