  ...
  return (
    <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8 ">
      <div className="mx-auto max-w-lg">
        ...
        >
          <p className="text-2xl font-medium text-[#413F9D]">Personal Form</p>
          ...
          <div>
            ...
            <div className="relative mt-1">
              <input
                ...
                className={`w-full rounded-lg border-gray-200 p-4 pr-12 text-sm shadow-sm ${validation.birth}`}
              />
            </div>
          </div>
          <div className="">
            ...
            <div className="relative mt-1">
              <input
                ...
                className={`w-full rounded-lg border-gray-200 p-4 pr-12 text-sm shadow-sm" placeholder="Enter your Cityv ${validation.city}`}
              />
            </div>
          </div>
          <div className="">
          ...
          <div className="">
            <label
              ...
              className="sm:text-lg text-md font-normal text-[#413F9D]"
            >
              Household income per year <span className="text-red-600">*</span>
            </label>
            ...
            <div className="relative mt-1">
              <select
                ...
                className={`block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500 ${validation.household_income}`}
              >
                <option value="">Select...</option>
          ...
          <div className="">
            ...
            <div className="relative mt-1">
              <select
                ...
                onChange={(e) =>
                  setFormData({ ...formData, level_education: e.target.value })
                }
                className={`block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500 ${validation.level_education}`}
              >
                <option value="">Select...</option>
          ...
          <div className="">
            ...
            <div className="relative mt-1">
              <select
                ...
                className={`block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500 ${validation.marital_status}`}
              >
                <option value="">Select...</option>
          ...
          <div className="py-4">
            ...
            <input
              ...
              className={`form-radio  border-primary-100 border-2 ${validation.children}`}
              value="Infant"
              checked={formData.children === "Infant"}
            />
            <label
              className="sm:ml-2 font-medium sm:text-lg text-sm"
              htmlFor="checkbox2"
            ...
            <input
              ...
              className={`form-radio  border-primary-100 border-2 ${validation.children}`}
              value="Toddler"
              checked={formData.children === "Toddler"}
            />
            <label
              className="sm:ml-2 font-medium sm:text-lg text-sm"
              htmlFor="checkbox3"
            ...
            <input
              ...
              className={`form-radio  border-primary-100 border-2 ${validation.children}`}
              value="Preschooler"
              checked={formData.children === "Preschooler"}
            />
            <label
              className="sm:ml-2 font-medium sm:text-lg text-sm"
              htmlFor="checkbox4"
            ...
            <input
              ...
              className={`form-radio  border-primary-100 border-2 ${validation.children}`}
              value="School aged"
              checked={formData.children === "School aged"}
            />
            <label
              className="sm:ml-2 font-medium sm:text-lg text-sm"
              htmlFor="checkbox4"
            ...
            <input
              ...
              className={`form-radio  border-primary-100 border-2 ${validation.children}`}
              value="Adolescent"
              checked={formData.children === "Adolescent"}
            />
            <label
              className="sm:ml-2 font-medium sm:text-lg text-sm"
              htmlFor="checkbox4"
            ...
            <input
              ...
              className={`form-radio  border-primary-100 border-2 ${validation.children}`}
              value="Adult"
              checked={formData.children === "Adult"}
            />
            <label
              className="sm:ml-2 font-medium sm:text-lg text-sm"
              htmlFor="checkbox4"
          ...
          <div className="">
            ...
            <div className="relative mt-1">
              <select
                ...
                onChange={(e) =>
                  setFormData({ ...formData, living_situation: e.target.value })
                }
                className={`block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500 ${validation.living_situation}`}
              >
                <option value="">Select...</option>
                <option value="Live alone">Live alone</option>
                <option value="Live in household with other people">
                  Live in household with other people
                </option>
                <option value="Live in residential facility where meals and household help">
                  Live in residential facility where meals and household help
                </option>
                <option value="Live in facility such as nursing home">
                  Live in facility such as nursing home
                </option>
                <option value="Temporarily staying with a relative or friend">
                  Temporarily staying with a relative or friend
                </option>
                <option value="Temporarily staying in a shelter or homeless">
          ...
          <div className="">
            <label
              ...
              className="sm:text-lg text-md font-normal text-[#413F9D]"
            >
              Home Owner <span className="text-red-600">*</span>
            </label>
            ...
            <div className="relative mt-1">
              <select
                ...
                onChange={(e) =>
                  setFormData({ ...formData, home_owner: e.target.value })
                }
