    ...
    return (
      ...
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8 ">
        <div className="mx-auto max-w-lg">
          ...
          <h3 className="text-center text-xl font-semibold text-black sm:text-2xl">
          ...
          <div className='flex flex-row space-x-8'>
            <div className='w-1/2 hover:-translate-y-1 hover:scale-110'>
              ...
              <p className='text-center font-medium text-2xl '>Researcher</p>
              </button>
            </div>
            <div className='w-1/2 hover:-translate-y-1 hover:scale-110'>
            <button onClick={chooseRole}><img src="/img/worker.png" />
          ...
          <div  className={`mt-6 mb-0 space-y-4 rounded-lg p-8 shadow-2xl ${form.invisible}`}>
            ...
            <div>
              <label htmlFor="email" className="text-2xl font-medium text-[#413F9D]">Email</label>
            ...
            <div className=''>
              <label htmlFor="name" className="text-2xl font-medium text-[#413F9D]">Password</label>
            ...
            <div className=''>
              <label htmlFor="name" className="text-2xl font-medium text-[#413F9D]">Repeat your Password</label>
            ...
            <p className='text-center sm:text-medium text-sm'>By Clicking &apos;Sign Up&apos; I agree to the User interviews <Link href="/terms" ><a className="text-blue-600  sm:text-medium text-sm">Terms of service</a></Link>,<a className="text-blue-600 sm:text-medium text-sm"><Link href="/privacy" > Privacy Policy</Link></a>, and <Link href="/cookies" ><a className="text-blue-600 sm:text-medium text-sm">Cookies Policy</a></Link></p>
